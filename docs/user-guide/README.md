...
| [Фиксация правил (Latching)](rule-latching.md) | Защита от каскадных сбоев с помощью поля `keep` |
...
| [Мультикластерное развёртывание](multi-cluster.md) | Развёртывание аддонов в удалённые кластеры через AddonClaim |
